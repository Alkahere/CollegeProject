...
if (isset ($_SESSION['session_user_id'])) {
	if (isset ($_POST['outward_id'])) {
		...
		if (isset ($_POST['limit']))
			...
			$query .= " WHERE fd_is_dispatched = ".$_POST['mode'].";";
		else
			$query .= ";";
	}
